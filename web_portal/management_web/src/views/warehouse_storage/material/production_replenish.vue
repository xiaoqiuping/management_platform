...
<!--          </el-form-item>-->
    ...
    <div class="table-container">
      <el-table ref="adminTable"
        ...
        <el-table-column label="补料人" align="center">
          <template slot-scope="scope">{{ scope.row.duty_man }}</template>
        </el-table-column>
        <el-table-column label="补料时间" align="center">
    ...
    <el-dialog
      ...
      <el-form :model="mainEntry"
        ...
        <el-form-item label="操作类型：" class="marginBottom22">补料</el-form-item>
        <el-form-item label="补料人：" class="marginBottom22" prop="duty_man">
          <el-input v-model="mainEntry.duty_man" class="width450"></el-input>
        </el-form-item>
        <el-form-item label="补料时间：" class="marginBottom22" prop="operation_time">
          <el-date-picker
    ...
    <!--    补料详情-->
    <el-dialog
      :title="this.mainEntry.duty_man+'的补料详情'"
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        duty_man: [
          {required: true, message: '补料人不能为空'},
        ],
        operation_time: [
          {required: true, message: '补料时间不能为空'},
        ],
      }
    }
  },
