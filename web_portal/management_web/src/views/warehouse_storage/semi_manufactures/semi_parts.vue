  ...
  <div class="app-container">
    ...
    <el-card class="filter-container" shadow="never" style="padding: 10px 5px">
      ...
      <div>
        <el-form :inline="true" :model="param" size="small" label-width="140px">
          <el-form-item>
            <el-input v-model="param.semi_manufacture_name" class="input-width" placeholder="半成品零件名称"
                      clearable></el-input>
          </el-form-item>
          <el-form-item>
            <el-input v-model="param.semi_manufacture_model" class="input-width" placeholder="半成品零件型号"
                      clearable></el-input>
          </el-form-item>
          <el-form-item>
    ...
    <div class="table-container">
      <el-table ref="adminTable"
        ...
        <el-table-column label="半成品零件名称" align="center">
          <template slot-scope="scope">{{ scope.row.semi_manufacture_name }}</template>
        </el-table-column>
        <el-table-column label="半成品零件型号" align="center">
...
<!--            </el-button>-->
    ...
    <!--添加编辑页面-->
    <el-dialog
      :title="isEdit?'编辑半成品零件信息':'新增半成品零件信息'"
      ...
      <el-form :model="mainEntry"
        ...
        <el-form-item label="半成品零件名称/型号：" class="marginBottom22" prop="semi_manufacture_name">
...
export default {
    ...
    return {
      ...
      rules: {
        semi_manufacture_name: [
          {required: true, message: '半成品零件名称/型号不能为空'},
        ],
        operation_num: [
  ...
  methods: {
    ...
    getMaterialList() {
      this.listLoading = true;
      listAllByType({materialType: 2, childrenType: 1}).then(response => {
        this.listLoading = false;
