  ...
  <div class="app-container">
    ...
    <el-card class="filter-container" shadow="never" style="padding: 10px 5px">
      ...
      <div>
        <el-form :inline="true" :model="param" size="small" label-width="140px">
          <el-form-item>
            <el-input v-model="param.manufacture_name" class="input-width" placeholder="成品表名称" clearable></el-input>
          </el-form-item>
          <el-form-item>
            <el-input v-model="param.manufacture_model" class="input-width" placeholder="成品表型号" clearable></el-input>
          </el-form-item>
          <el-form-item>
    ...
    <div class="table-container">
      <el-table ref="adminTable"
        ...
        <el-table-column label="成品表名称" align="center">
          <template slot-scope="scope">{{ scope.row.manufacture_name }}</template>
        </el-table-column>
        <el-table-column label="成品表型号" align="center">
    ...
    <el-dialog
      ...
      <el-form :model="mainEntry"
        ...
        <el-form-item label="成品表名称/型号：" class="marginBottom22" prop="manufacture_name">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        manufacture_name: [
          {required: true, message: '成品表名称/型号不能为空'},
        ],
        operation_num: [
