  ...
  <div class="app-container">
    ...
    <el-card class="filter-container" shadow="never" style="padding: 10px 5px">
      ...
      <div>
        <el-form :inline="true" :model="param" size="small" label-width="140px">
          ...
          <el-form-item>
            <el-input v-model="param.duty_man" class="input-width" placeholder="退料人" clearable></el-input>
          </el-form-item>
        </el-form>
      </div>
    </el-card>
    ...
    <div class="table-container">
      <el-table ref="adminTable"
        ...
        <el-table-column label="退料人" align="center">
          <template slot-scope="scope">{{ scope.row.duty_man }}</template>
        </el-table-column>
        <el-table-column label="退料时间" align="center">
    ...
    <el-dialog
      ...
      <el-form :model="mainEntry"
        ...
        <el-form-item label="退料人：" class="marginBottom22" prop="duty_man">
          <el-input v-model="mainEntry.duty_man" class="width450"></el-input>
        </el-form-item>
        <el-form-item label="退料时间：" class="marginBottom22" prop="operation_time">
          <el-date-picker
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        duty_man: [
          {required: true, message: '退料人不能为空'},
        ],
        material_name: [
          {required: true, message: '杂料名称不能为空'},
        ],
        operation_time: [
          {required: true, message: '退料时间不能为空'},
        ],
        operation_num: [
