...
<script>
import {listPage, save, remove, update} from '@/api/sale/contract'
...
export default {
  ...
  methods:{
    ...
    handleUploadSuccess (file) {
      this.mainEntry.file_list.push(file.data)
    },
    handleRemove(file, fileList) {
      var index = this.mainEntry.file_list.indexOf(file)
      if (index !== -1) {
        this.mainEntry.file_list.splice(index, 1)
      }
    },
