  ...
  <div class="app-container">
    ...
    <el-card class="filter-container" shadow="never" style="padding: 10px 5px">
      ...
      <div>
        <el-form :inline="true" :model="param" size="small" label-width="140px">
          ...
          <el-form-item>
            <el-input v-model="param.goods_type" class="input-width" placeholder="商品型号" clearable></el-input>
          </el-form-item>
        </el-form>
      </div>
    </el-card>
    ...
    <div class="table-container">
      <el-table ref="adminTable"
        ...
        <el-table-column label="商品型号" align="center">
          <template slot-scope="scope">{{ scope.row.goods_type }}</template>
        </el-table-column>
    ...
    <el-dialog
      ...
      <el-form :model="mainEntry"
        ...
        <el-form-item label="商品名称：" class="marginBottom22" prop="goods_name">
          <el-input v-model="mainEntry.goods_name" class="width450"></el-input>
        </el-form-item>
        <el-form-item label="商品型号：" class="marginBottom22" prop="goods_type">
          <el-input v-model="mainEntry.goods_type" class="width450"></el-input>
        </el-form-item>
...
<script>
import {listPage, save, remove, update} from '@/api/sale/salePrice'
const defaultPage = {
  page: 1,
  size: 10,
  total: 0
  ...
  data(){
    return {
      ...
      rules: {
        ...
        goods_type: [
          {required: true, message: '商品型号不能为空'},
        ],
        price: [
