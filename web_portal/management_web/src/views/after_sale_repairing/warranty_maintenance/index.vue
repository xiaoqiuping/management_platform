    ...
    <el-card class="filter-container" shadow="never" style="padding: 10px 5px">
      ...
      <div>
        <el-form :inline="true" :model="param" size="small" label-width="140px">
          <el-form-item>
            <el-input v-model="param.buyer_name" class="input-width" placeholder="客户名称" clearable></el-input>
          </el-form-item>
          <el-form-item>
        ...
        <el-table-column label="操作" width="180" align="center">
          <template slot-scope="scope">
            ...
            <el-button size="mini" v-if="scope.row.status<2"
                       type="text"
                       @click="handleFinished(scope.$index, scope.row)">完成
            </el-button>
            <el-button size="mini"
                       type="text"
        ...
        <div>
          <el-form :model="mainEntry"
            ...
            <el-form-item label="维修类别：" style="margin-bottom: 10px">
              <span class="margintop10">保外维修</span>
            </el-form-item>
