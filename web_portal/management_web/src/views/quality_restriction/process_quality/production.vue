...
<!--      <el-button size="primary" class="btn-add" @click="handleExport()"><i class="el-icon-setting left_icon"></i>导出-->
<!--      </el-button>-->
      ...
      <el-table ref="adminTable"
        ...
        <el-table-column label="操作" width="180" align="center">
          <template slot-scope="scope">
            <el-button size="mini" v-if="scope.row.status===9"
                       type="text"
    ...
    <el-dialog
      ...
      <el-form :model="mainEntry"
        ...
        <el-form-item label="类型：" style="margin-bottom: 10px">
          <el-input :value="mainEntry.type | typeFilter" style="width: 350px" disabled></el-input>
        </el-form-item>
        ...
        <el-form-item label="质检状态：" style="margin-bottom: 10px">
          <el-radio v-model="mainEntry.status" :label="10" border>审核通过</el-radio>
          <el-radio v-model="mainEntry.status" :label="9" border>审核未通过</el-radio>
        </el-form-item>
        <el-form-item label="质检意见：" style="margin-bottom: 10px">
...
<script>
import {listPage, examineOrder} from '@/api/warehouse_storage/production_order'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      listPage(this.param, this.page,'PZJY').then(response => {
